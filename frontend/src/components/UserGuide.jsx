...
const sections = [
  ...
  {
    id: "admin",
    title: "관리자 (Admin) 대시보드",
    icon: "👑",
    content: (
      <>
        <p>Admin 계정으로 로그인하면 관리자 전용 대시보드가 표시됩니다.</p>
        <h4>대시보드 개요</h4>
        <ul>
          <li><b>API 사용량</b> — 월간 사용/잔여 크레딧 (총 20,000)</li>
          <li><b>계정별 선박 수</b> — 각 회사가 관리 중인 선박 현황</li>
          <li><b>일별 API 사용 추이</b> — 최근 30일 차트</li>
        </ul>
        <h4>선박 관리</h4>
        <ul>
          <li>모든 계정의 선박 목록을 한 눈에 조회</li>
          <li>선박을 다른 계정으로 <b>이동</b> (소속 변경)</li>
          <li>선박 <b>활성/보관</b> 상태 변경</li>
          <li>선박 <b>삭제</b></li>
        </ul>
        <h4>계정 관리</h4>
        <ul>
          <li>모든 계정의 비밀번호를 변경할 수 있습니다.</li>
          <li>계정별 생성일, 역할 정보 확인 가능합니다.</li>
        </ul>
      </>
    ),
  },
